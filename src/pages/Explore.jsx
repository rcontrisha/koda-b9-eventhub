    ...
    <>
      ...
      <div className="px-4 py-8 lg:py-10 lg:px-13">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link to={`/communities/${slugify(joined_communities[0].name.toLowerCase())}`} className="font-inter text-sm font-normal text-secondary">
            See all
          </Link>
        </div>
      ...
      <div className="px-4 py-8 lg:py-10 lg:px-13">
        <div className="flex justify-between items-center">
          ...
          <Link to={"/events"} className="font-inter text-sm font-normal text-secondary">
            See all
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-5">
      ...
      <div className="px-4 py-8 lg:py-10 lg:px-13">
        <div className="flex justify-between items-center">
          ...
          <Link to={"/communities"} className="font-inter text-sm font-normal text-secondary">
            See all
          </Link>
        </div>
